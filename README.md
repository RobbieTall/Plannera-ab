...
Latest protected evidence (2026-07-16): [Commercial Funnel Live Audit run 29492417071, attempt 2](https://github.com/RobbieTall/Plannera-ab/actions/runs/29492417071) authenticated against deployed commit `c723a8932e697e7f86860eb57f02f551ab6baf5e` and returned controlled exit `2`: both approved projects had valid audit contracts but no saved current-site Quick Site Check, Detailed Planning Pack, or SEE artefacts, so referral eligibility was `none`. The safe artifact is `8373345476` with digest `sha256:7080d322dc8f9d6bd3700e691e0a33fb876a585a751da42b685829b35384fa9b`. The commercial and billing/auth gates remain open; the missing chains must be generated through the normal product workflow with real proposal briefs, never fabricated or backfilled by the audit.
