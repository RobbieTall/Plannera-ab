...
- The map UI captures the full provenance contract and exposes truthful review controls/status. Focused service and map-creation regressions are included in the Commercial Funnel Golden Gate; clean remote Prisma generation, tests and Vercel Preview remain required before merge.
