...
Issue #427 adds Byron R2 (33 Lorikeet Lane, reviewed storage-shed case) and Kempsey SP2 (32 Smith St, infrastructure truth case). Byron R2 deliberately omits DCP evidence and terminates as expert-review material. Kempsey SP2 is not given synthetic statutory land-use evidence; its QSC remains uncited and the paid-pack gate must block progression. Kempsey SP2 must not inherit E2 Commercial Centre terms or controls.
