  ...
  it("excludes rural/residential-only provisions for Byron SP3 tourist sites", async () => {
    ...
    dcpFindManyMock.mockResolvedValue([
      ...
      },
      {
        ...
        ref: "BYRON-SP3-MIXED",
        title: "SP3 Tourist mixed accommodation controls",
        headingPath: ["Chapter D", "SP3 Tourist"],
        bodyText: "Zone SP3 Tourist controls include tourist and visitor accommodation and may mention residential accommodation only as a neighbouring use.",
      },
      {
        ...baseClause,
        id: "rural-secondary",
    ...
    instrumentFindManyMock.mockResolvedValueOnce([
      {
        ...
        clauses: [
          ...
          },
          {
            clauseKey: "4.3-SP3",
            title: "Height of buildings",
            bodyText: "The height controls apply to Zone SP3 Tourist, business areas and some residential areas; residential wording does not make this clause residential-only.",
          },
          {
            clauseKey: "4.2A",
